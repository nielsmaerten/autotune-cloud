...
async function handleRequest(
    ...
    const openApsFiles = await generateOpenApsFiles(settings)
        .catch(e => onError(e, "generating openAPS files"));

    // Run Autotune
    let recommendations = await runAutotune(openApsFiles, settings)
        .catch(e => onError(e, "running autotune"));
