...
module.exports = async (settings) => {
    ...
    try {
        const backupProfile =
            profileConverter.convertProfile(profiles[settings.profileNames.backup], settings.min5mCarbImpact);
        const autotuneProfile =
            profileConverter.convertProfile(profiles[settings.profileNames.autotune], settings.min5mCarbImpact);
